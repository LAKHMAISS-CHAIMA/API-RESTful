    ...
    <div className='flex flex-col items-center justify-center min-h-screen bg-gray-100'>
      <form onSubmit={handleSubmit} className='relative flex w-96 flex-col rounded-xl bg-white text-gray-700 shadow-md mx-auto my-10 px-6 py-8'>
        ...
        <div className='mb-4'>
          ...
          <input name='email' type='email' value={formData.email} onChange={handleChange} placeholder='vous@example.com' className='w-full rounded-md border border-blue-gray-200 px-3 py-2 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-cyan-500' required /></div>

        <div className='mb-4'>
          <label className='block mb-2 text-sm font-medium text-gray-900'>Mot de passe</label>
          <input name='password' type='password' value={formData.password} onChange={handleChange} placeholder='••••••••' className='w-full rounded-md border border-blue-gray-200 px-3 py-2 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-cyan-500' required /></div>
        ...
        <div className='mb-4 flex items-center'>
          ...
          <label htmlFor='remember' className='ml-2 block text-sm text-gray-900'> Se souvenir de moi</label></div>
